...
// Transpose collection of sequences to obtain SIMD vectors
using simd_score_t = std::array<int16_t, sequence_count_v>;
// row of transposed object should have a width equal to the number of sequences
...
result_t compute_alignment(std::vector<sequence_t> const& sequences1,
    ...
    result_t result{};
    auto sequence1 = transpose(sequences1);
    auto sequence2 = transpose(sequences2);
